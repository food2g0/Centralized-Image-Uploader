...
def open_admin_dashboard_group1(admin_data, switch_group_callback=None):
    """Open admin dashboard for Group 1 using shared module"""
    create_admin_dashboard(
        admin_data=admin_data,
        group_corporations=group1_corporations,
        add_user_popup_func=open_add_user_popup_group1,
        group_name_display="Group 1",
...
# ============================================================
def _old_open_admin_dashboard_group1(admin_data):
    ...
    def load_branches_only():
        ...
        try:
            ...
            branches_list = get_branches_from_index(list(group1_corporations))
            ...
            docs = db.collection("Uploaded_Images").where("corporations", "in", list(group1_corporations)[:10]).select(["branch"]).limit(500).stream()
